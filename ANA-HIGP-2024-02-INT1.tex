...
\input{ANA-HIGP-2024-02-INT1-metadata}
...
\include{sections/EventSelections}
\include{sections/ObservablesBinning}
\include{sections/SignalBackgroundModelling}
\include{sections/BackgroundEstimation}

\include{sections/Systematics}
\include{sections/TheoryModelling}

\include{sections/Unfolding}

\include{sections/SignalYields}
\include{sections/AsimovResults}
%\include{sections/DataResults} %After unblinding
...
\include{appendices/DAODs}
\include{appendices/SignalModelFit}
\include{appendices/BackgroundTemplate.tex}
\include{appendices/SpuriousSignal}
\include{appendices/SidebandFit}
...
\include{appendices/ProductCut}
\include{appendices/TruthIsolation}
