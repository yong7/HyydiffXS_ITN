...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{efficiency_vs_purity_plot_123_127_GeV.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{efficiency_vs_purity_relpt2_025_with_default.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{sig_myys_comparison_weighted.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{bkg_myys_comparison_weighted.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{efficiency_purity_comparison_123_127_032.pdf}
