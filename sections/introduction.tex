...
the inclusive diphoton region dominated by the ggF production, as well as regions enhanced in VBF, \ZH, \WH and \ttH production. In the diphoton region, differential cross-sections of eight variables ($\ptgg$, $\ygg$, $\Njets{}$, $\ptj$, $\dphijj$, $\mjj$, $\Nbjets$ and $\Nlept$) are measured. Significant changes made in this analysis include
