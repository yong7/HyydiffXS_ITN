...
The Spurious results for all variable bins in \ptgg  are summarized in Table \ref{tab:sp_signal_pT_yy}.The detailed information for other variables can be found in Appendix \ref{app:spurious_signal} 
\begin{table}
