...
\paragraph{PS+Hadronisation} Uncertainty due to the modelling of parton showers and hadronisation is estimated using alternative MC predictions using Herwig 7.2.3 \cite{Bellm:2015jjp,Bellm:2020epjc}. These alternative samples use the same matrix element generators as the nominal samples. Herwig 7.2 uses an angular-ordered parton shower and a cluster-based hadronisation model, as opposed to the \pT-ordered shower and Lund-string hadronisation used in Pythia 8.  
