...
\begin{table}[!htbp]
  ...
  \begin{tabular}{clc}
    %\hline\hline
    \toprule
    Year & GRL & $\mathcal{L}_\text{int}$ (\ifb) \\
    \hline
    2022 & \texttt{\tiny data22\_13p6TeV.periodAllYear\_DetStatus-v109-pro28-04\_MERGED\_PHYS\_StandardGRL\_All\_Good\_25ns\_ignore\_TRIGLAR.xml} & 29.05 \\
   %\hline
    2023 & \texttt{\tiny data23\_13p6TeV.periodAllYear\_DetStatus-v110-pro31-06\_MERGED\_PHYS\_StandardGRL\_All\_Good\_25ns\_ignoreTRIG\_JETCTPIN.xml}  & 27.24\\
    %\hline
...
of tuned parameters~\cite{Bellm:2015jjp,Bellm:2020epjc} and the \MMHT[lo] PDF set~\cite{Harland-Lang:2014zoa}.
...
\begin{table}[!htbp]
  ...
  % \scriptsize
  \begin{tabular}{l R{3cm} c R{3cm}}
    %\hline
    %\hline
    \toprule
    Production mode & $\sigma\times BR$ at $\sqrt{13.6}$~\TeV [fb] & Accuracy (of $\sigma$) & Total events in 166~\ifb \\
    \hline
