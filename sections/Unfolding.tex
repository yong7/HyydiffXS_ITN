...
\ASnote[Figures]{Add response matrices}. Dalitz events are excluded at both particle and detector level. The migration matrices, as well as the response matrices and correction factors
