...
Photons are calibrated using the latest Run-3 calibration corrections for the energy scale and resolution detailed in~\textcolor{red}{XXX add references}. These corrections are tagged with the model~\texttt{es2022\_R22\_PRE}. Unless otherwise specified, the results reported in this document are obtain with this model. 
...
The reconstruction and selection of these objects is common to other SM \Hyy analyses and it is described in great details in the common performance note \cite{Nomidis:2718255} and in the STXS/coupling note \cite{Berger:2764716}.\textcolor{red}{XXX old Run 2 references, update} 
These objects are not used for the nominal categorization selection. 
...
\textbf{Photons}
\begin{itemize}
	\item ESModel: \path{es2022_R22_PRE}
...
\textbf{Electrons, Muons, Jets, B-Jet}: same recommendations as the one reported in the Run 3 partial result \textcolor{red}{Update references with up-to-date recommendations}
