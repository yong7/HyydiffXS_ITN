...
The motivation for using particle level isolation and the method for choosing the cut is discussed further in Appendix~\textcolor{blue}{placeholder for Pablo's studies on truth level isolation}. 
