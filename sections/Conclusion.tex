...
Measurements of Higgs boson fiducial cross-sections in the diphoton decay channel have been performed using \pp\ collision data recorded by the ATLAS experiment at the LHC, assuming the Higgs boson mass to be \SI{125.09}{\GeV}.
The data were taken at a centre-of-mass energy of \(\sqrt{s}=\SI{13.6}{\TeV}\) and correspond to the partial Run 3 data set collected between 2022 and 2024 with a total integrated luminosity of \SI{165.2}{\ifb}.

The measurements were performed in a diphoton fiducial region requiring two isolated photons with transverse momentum greater than 35\% and 25\% of the diphoton invariant mass, and \(|\eta|<2.37\) (excluding the region of \(1.37 < |\eta|<1.52\)).
The inclusive fiducial cross-section times branching ratio was measured to be \textcolor{red}{to be filled}
%\begin{align*}
...
In addition, cross-section measurements are reported in various fiducial regions probing Higgs boson production from vector-boson fusion or associated with large missing transverse momentum, leptons or top quarks. The measured cross-sections times branching ratio for the these fiducial regions were: \textcolor{red}{to be filled}
%\begin{align*}
