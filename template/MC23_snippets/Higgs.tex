...
\begin{table}[!htbp]
  ...
  \begin{tabular}{ l | l | l}
    ...
    345124 & \(H\to\tau\tau\to \mu\tau\)          & \\ %\(\pTX[][h1] > \qty{30}{\GeV}\) and \(\pTX[][h2]    > \qty{20}{\GeV}\)
    345125 & \(H\to\tau\tau\to e \tau\)           & \\ %\(\pTX[][h1] > \qty{30}{\GeV}\) and \(\pTX[][h2]    > \qty{20}{\GeV}\)
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[!htbp]
  ...
  \begin{tabular}{ l l l}
    ...
    346194 & \(H\to\tau\tau\to e\tau\)           & \\%\(\pTX[][l1] > \qty{10}{\GeV}\) and \(\pTX[][h1]    > \qty{20}{\GeV}\) \\
    346195 & \(H\to\tau\tau\to \mu\tau\)         & \\%\(\pTX[][l1] > \qty{10}{\GeV}\) and \(\pTX[][h1]    > \qty{20}{\GeV}\) \\
    \bottomrule
  \end{tabular}
\end{table}
...
%External fermion masses are neglected throughout.  For the choice of renormalisation and factorisation scales, various options are available.  For this report, fixed scales,μF=μR=MW, are used, and contributions from external bottom and top quarks are entirely disregarded.
...
The descriptions below correspond to the samples in \crefrange{tab:higgs-ZH-samples}{tab:higgs-ggZH-samples}.
...
and next-to-leading-logarithm accuracy in QCD for
\(gg \to ZH\)~\cite{Ciccolini:2003jy,Brein:2003wg,Brein:2011vx,Altenkamp:2012sx,Denner:2014cla,Brein:2012ne,Harlander:2014wda}.
The normalisation of all Higgs boson samples accounts for the decay branching ratio calculated with
